      ...
      <section className="gallery-section" id="gallery">
        <div className="gallery-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Uma coleção das mais belas imagens do universo
            </p>
          </div>
          <div className="gallery-grid">
            <figure className="gallery-item large-item">
              ...
              <figcaption className="gallery-overlay">
                <h4>Nebulosa de Formação Estelar</h4>
                <p>Berçário de estrelas em cores vibrantes</p>
              </figcaption>
            </figure>
            <figure className="gallery-item">
              ...
              />
              <figcaption className="gallery-overlay">
                <h4>Galáxia Espiral</h4>
                <p>Majestosa estrutura em espiral</p>
              </figcaption>
            </figure>
            <figure className="gallery-item">
              <img
              ...
              />
              <figcaption className="gallery-overlay">
                <h4>Sistema Planetário</h4>
                <p>Planeta com suas luas naturais</p>
              </figcaption>
            </figure>
            <figure className="gallery-item tall-item">
              ...
              <figcaption className="gallery-overlay">
                <h4>Aurora Boreal</h4>
                <p>Dança de luzes nos polos terrestres</p>
              </figcaption>
            </figure>
            <figure className="gallery-item">
              <img
              ...
              />
              <figcaption className="gallery-overlay">
                <h4>Telescópio Espacial</h4>
                <p>Tecnologia avançada de observação</p>
              </figcaption>
            </figure>
            <figure className="gallery-item wide-item">
              ...
              <figcaption className="gallery-overlay">
                <h4>Via Láctea</h4>
                <p>Nossa galáxia vista da Terra</p>
              </figcaption>
            </figure>
          </div>
        </div>
